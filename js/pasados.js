...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    $("#pasados").append("<div class='col-md-8 bg-white mb-5'>"
                          + "<h2 class='text-primary'>" + pasados[i].nombre + "</h2>"
                          + "<p class='text-secondary'>" + pasados[i].fecha + "</p>"
                          + "<p>"+ pasados[i].descripcion + "</p>" +
                          "</div>"
                          );
    }
